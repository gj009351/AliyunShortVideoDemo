...
public class MediaActivity extends Activity implements View.OnClickListener{
    ...
    private void getData(){
        ...
        minVideoDuration = getIntent().getIntExtra(AliyunSnapVideoParam.MIN_VIDEO_DURATION,20000);
        maxVideoDuration = getIntent().getIntExtra(AliyunSnapVideoParam.MAX_VIDEO_DURATION,10 * 60 *1000);
        minCropDuration = getIntent().getIntExtra(AliyunSnapVideoParam.MIN_CROP_DURATION,20000);
        ...
        minDuration = getIntent().getIntExtra(AliyunSnapVideoParam.MIN_DURATION,20000);
        maxDuration = getIntent().getIntExtra(AliyunSnapVideoParam.MAX_DURATION,60000);
