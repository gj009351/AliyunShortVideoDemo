...
public class AlivcSvideoRecordActivity extends AppCompatActivity {
    ...
    private void getData() {
        ...
        mMinDuration = getIntent().getIntExtra(AliyunSnapVideoParam.MIN_DURATION, 20000);
        ...
        mMinCropDuration = getIntent().getIntExtra(AliyunSnapVideoParam.MIN_CROP_DURATION,20000);
        mMinVideoDuration = getIntent().getIntExtra(AliyunSnapVideoParam.MIN_VIDEO_DURATION,20000);
        mMaxVideoDuration = getIntent().getIntExtra(AliyunSnapVideoParam.MAX_VIDEO_DURATION,60000);
        mSortMode = getIntent().getIntExtra(AliyunSnapVideoParam.SORT_MODE, AliyunSnapVideoParam.SORT_MODE_VIDEO);
