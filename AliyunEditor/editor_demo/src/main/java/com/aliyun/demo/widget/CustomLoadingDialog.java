...
public class CustomLoadingDialog extends Dialog {
    ...
    public CustomLoadingDialog(Context context, int height) {
    ...
    private void init() {
        ...
        View view = inflater.inflate(R.layout.aliyun_svideo_dialog_circle_progress, null, false);
        mImageView = view.findViewById(R.id.iv_dialog_progress);
        mImageView.setImageResource(R.mipmap.aliyun_svideo_icon_circle_progress);
        setAnimation();
        setContentView(view);
